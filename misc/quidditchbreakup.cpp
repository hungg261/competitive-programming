/******************************************************************************
Link: https://coding.fit.hcmus.edu.vn/problem/quidditchbreakup
Code: quidditchbreakup
Time (YYYY-MM-DD-hh.mm.ss): 2026-09-21-18.18.47
*******************************************************************************/
#include<bits/stdc++.h>
using namespace std;
...
void solve(){
    ...
    for(int i = 1; i <= o; ++i){
        int x; cin >> x;
        flow.addEdge(S, x, INF, false);
    }
    for(int i = 1; i <= t; ++i){
        int x; cin >> x;
        flow.addEdge(x, T, INF, false);
    }
